...
public class Matrix implements Parcelable {
	...
	public void toXRot(float angleX) {
		set(1f, 0f, 0f, 0f, FloatMath.cos(angleX), -FloatMath.sin(angleX), 0f,
				FloatMath.sin(angleX), FloatMath.cos(angleX));
	}

	public void toYRot(float angleY) {
		set(FloatMath.cos(angleY), 0f, FloatMath.sin(angleY), 0f, 1f, 0f,
				-FloatMath.sin(angleY), 0f, FloatMath.cos(angleY));
	}

	public void toZRot(float angleZ) {
		set(FloatMath.cos(angleZ), -FloatMath.sin(angleZ), 0f,
				FloatMath.sin(angleZ), FloatMath.cos(angleZ), 0f, 0f, 0f, 1f);
	}
